...
const vacpic = document.querySelectorAll('.vacpic');
const vacName = document.querySelectorAll('.vac-top p');
const vacD = document.querySelectorAll('.vac-bot p');
...
function toSwitchToBlack() {
    ...
    mPreview.style.background = 'url("styles/hstop2.jpg")';
    ...
    vacpic.forEach(Element => {
        Element.src = Element.src.substr(0, Element.src.length - 4) + "1.png";
    })
    vacName.forEach(Element => {
        Element.style.color = 'white';
    })
    vacD.forEach(Element => {
        Element.style.color = 'white';
    })
    ...
    vac.forEach(e => e.style.boxShadow = 'rgba(92, 135, 63, 0.69) 0px 0px 15px');
...
function toSwitchToWhite() {
    ...
    mPreview.style.background = 'url("styles/hstop.jpg")';
    mPreview.style.backgroundSize = 'cover';
    mPreview.style.backgroundPosition = 'center';

    vacpic.forEach(Element => {
        Element.src = Element.src.substr(0, Element.src.length - 5) + ".png";
    })
    vacName.forEach(Element => {
        Element.style.color = 'black';
    })
    ...
    vac.forEach(e => e.style.boxShadow = '0 0 15px rgba(0, 0, 0, 0.25)');
...
const gCont = document.querySelectorAll('.gCont').forEach(Element => {
    Element.addEventListener('click', toOpenModal);
})
